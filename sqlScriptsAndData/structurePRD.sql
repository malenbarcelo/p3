...
/*DROP DATABASE IF EXISTS p3wnpower_db;*/

/*Create database*/
/*CREATE DATABASE p3wnpower_db;*/

/*Delete tables if exist*/
DROP TABLE IF EXISTS p3wnpower_db.users;
DROP TABLE IF EXISTS p3wnpower_db.users_categories;
DROP TABLE IF EXISTS p3wnpower_db.vehicles;

/*Create table users_categories*/
CREATE TABLE p3wnpower_db.users_categories (
...
/*Create table users*/
CREATE TABLE p3wnpower_db.users (
    id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE p3wnpower_db.vehicles (
    id INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE p3wnpower_db.detected_events (
    id INT NOT NULL AUTO_INCREMENT,
    vehicle_code VARCHAR(50) NOT NULL,
...
CREATE TABLE p3wnpower_db.detected_events_steps (
    id INT NOT NULL AUTO_INCREMENT,
